...
/usr/bin/sambamba view -S -f bam -l 0 /dev/stdin | /usr/bin/sambamba sort -t $THREADS -m 20G -o $OUTPUTDIR/${DATATYPE}_hisat2_align/aligned_bam/${PROVIDER}_aligned.bam /dev/stdin
