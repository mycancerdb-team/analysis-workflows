...
#General Folders
mkdir -p ${OUTPUTDIR}/output/{select_variants,mutect/split-ints,final,strelka/{indels,snv},varscan/{variants,indels,snv},pindel/split-beds,docm/{raw,decom},detect-variants,cnvkit,logs}
#RNA Folders
