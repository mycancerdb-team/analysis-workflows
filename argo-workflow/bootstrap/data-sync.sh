...
#General Folders
mkdir -p ${OUTPUTDIR}/output/{select_variants,mutect/{split-ints,sani,normalized,fpfilter},final,strelka/{indels,snv,sani,normalized,fpfilter},varscan/{variants,indels,snv,sani,normalized,fpfilter},pindel/{split-beds,sani,normalized,fpfilter},docm/{raw,decom},detect-variants,cnvkit,logs,samples/{cancer-exome,somatic-exome,cancer-rna}}
#RNA Folders
